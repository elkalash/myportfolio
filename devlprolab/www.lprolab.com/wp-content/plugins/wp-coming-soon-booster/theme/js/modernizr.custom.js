window.Modernizr = function (e, t, n) {
   ...
   for (var N in S)
      f(S, N) && (u = N.toLowerCase(), d[u] = S[N](), C.push((d[u] ? "" : "no-") + u));
   return d.addTest = function (e, t) {
      if ("object" === typeof e)
         for (var r in e)
            f(e, r) && d.addTest(r, e[r]);
      else {
         if (e === e.toLowerCase(), d[e] !== n)
            return d;
        ...
        function (e, t, n) {
           ...
           function l(e, n, r, o, i, l, s) {
              ...
              1 === N[n] && (y = 1, N[n] = []), "object" == e ? f.data = n : (f.src = n, f.type = e), f.width = f.height = "0", f.onerror = f.onload = f.onreadystatechange = function () {
                 u.call(this, y)
              }, g.splice(o, 0, b), "img" != e && (y || 2 === N[n] ? (j.insertBefore(f, E ? null : h), m(u, s)) : N[n].push(f))
           }
           ...
           p = function (e) {
              function t(e) {
                 ...
                 for (n = 0; a > n; n++)
                    r = e[n].split("="), (t = F[r.shift()]) && (i = t(i, r));
                 for (n = 0; o > n; n++)
                    i = w[n](i);
                 return i
              }
              ...
              if (o(e))
                 ...
                 for (l = 0; l < e.length; l++)
                    s = e[l], o(s) ? a(s, 0, f, 0) : x(s) ? p(s) : Object(s) === s && c(s, f);
              else
                 Object(e) === e && c(e, f)
